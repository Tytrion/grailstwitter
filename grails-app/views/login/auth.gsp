...
<div class="wrapper">
	<div class="container">
		...
		<form action='/login/authenticate' method='POST' id='loginForm' class='cssform' autocomplete='off'>
				<input placeholder="Nutzername" type='text' class='text_' name='username' id='username' />
				<input placeholder="Passwort" type='password' class='text_' name='password' id='password' />
