    ...
    <div class="container__item landing-page-container">
        <div class="content__wrapper">
            ...
            <header class="header">
                ...
                <h1 class="heading header__item">Fabian's Website</h1>
                ...
                <ul class="social-container header__item">
                    ...
                    <li class="social__icon social__icon--in">
                        <a target="_blank" href="instagram.com/my.username_fabian"><img src="https://image.flaticon.com/icons/svg/1077/1077042.svg" alt="instagram"></a>

                    </li>
                </ul>
            </header>

            <p class="coords">Copyright by Fabian</p>
            ...
            <div class="scroller">
                <p class="page-title"><g:link controller="status">start</g:link></p>
